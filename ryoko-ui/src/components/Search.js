    ...
    <form className='add-form' onSubmit={onSubmit}>
        <div className='form-control'>
            <label>
                ...
                <input type='number' placeholder='Population' onChange={(e) => setPopulation(e.target.value)} />
            </label>
            <label>
                Density
                <Dropdown options={operators} onChange={_onSelectDen} value={denOperator} placeholder="=" />
                <input type='number' step="0.1" placeholder='Density' onChange={(e) => setDensity(e.target.value)} />
            </label>
            <label>
                State
            ...
            <label>
                ...
                <input type='number' step="0.01" placeholder='Lat' onChange={(e) => setLat(e.target.value)} />
            </label>
            <label>
                Long
                <Dropdown options={operators} onChange={_onSelectLon} value={lonOperator} placeholder="=" />
                <input type='number' step="0.01" placeholder='Long' onChange={(e) => setLong(e.target.value)} />
            </label>
        </div>
